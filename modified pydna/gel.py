...
def weight_standard_sample(key, qty=Q_(100000, 'ng')): # originally 500
...
def gelplot_imshow(infig, distances, bandwidths, intensities, lanes, names,
...
#    fig = plt.figure()
    ax1 = infig.add_subplot(111, axisbg=str(back_col))
    ax1.hold(False) # This is my addition
    ax1.xaxis.tick_top()
        ...
        if plot:
            ...
            title = ('E = %.2f V/cm\n'
                     ...
                     'expo = %.1f' % (field.to('V/cm').magnitude,
                                      ...
                                      exposure))
            # Plot
            gelpic = gelplot_imshow(infig, distances, bandwidths, intensities, lanes,
                                    names, gel_len, wellx, welly, wellsep, res,
                                    cursor_ovr, back_col, band_col, well_col,
                                    noise, Itol, title, FWTM, False)
           # return gelpic # gelpic was commented out in the original
        return None
